...
def test_soundcard_wav_uses_chip_emulator_only_with_no_fallback():
    ...
    from ae_editor.audio.core import OplBackendUnavailable
    ...
    with patch("ae_editor.audio.core.synthesize_nuked_opl_wav", side_effect=OplBackendUnavailable("no backend")):
        try:
